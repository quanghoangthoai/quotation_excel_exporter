...
def export_excel_api(quotation_name):
    ...
    ws.cell(row=footer_row, column=11, value=f"Ngày {date.day:02d} Tháng {date.month:02d} Năm {date.year}").font = font_13
    ...
    ws.cell(row=footer_row + 3, column=1).alignment = left_alignment
    ...
    ws.cell(row=footer_row + 4, column=1).alignment = left_alignment
    ...
    ws.cell(row=footer_row + 5, column=1).alignment = left_alignment
